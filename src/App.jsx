...
{`UltraSongLab/`}
        ...
        {/* SEPARATED OUTPUTS — Style / Lyrics / Negative */}
        <div className="space-y-2">
          {/* STYLE block */}
        ...
        <div className={`text-center text-sm mt-4 leading-relaxed ${darkMode ? "text-slate-500" : "text-slate-400"}`}>
          Suno Custom Mode has 3 fields:<br/>
          <strong className="text-purple-500">Style</strong> · <strong className="text-pink-500">Lyrics</strong> · <strong className="text-red-500">Exclude</strong> — copy each separately above.
        </div>
        </>)}
      </div>
